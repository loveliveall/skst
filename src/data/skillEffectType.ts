...
export const SKILL_EFFECT_CATEGORY: SkillEffectCategory = {
  ...
  1011: { desc: 'SP 스킬 볼티지 획득량 추가', iconAssetPath: '/images/icons/skill/live_sp_vo_inc.png' },
...
export const PASSIVE_SKILL_CATEGORIES = [2001, 2002, 2003];
...
export const SKILL_EFFECT_TYPE: SkillEffectType = {
  ...
  100504: { desc: '스태미너 회복 (자신 테크닉 %)', scaleType: 'percent', ingameText: 'スタミナ回復', effectCategoryId: 1005 },
  ...
  100703: { desc: '쉴드 획득 (자신 어필 %)', scaleType: 'percent', ingameText: 'シールド獲得', effectCategoryId: 1007 },
  ...
  101101: { desc: 'SP 볼티지 획득량 추가 (자신 어필 %)', scaleType: 'percent', ingameText: 'SP特技UP', effectCategoryId: 1011 },
  101102: { desc: 'SP 볼티지 획득량 추가 (고정 수치)', scaleType: 'fixed', ingameText: '', effectCategoryId: 1011 },
  101103: { desc: 'SP 볼티지 획득량 추가 (자신 테크닉 %)', scaleType: 'percent', ingameText: '', effectCategoryId: 1011 },
...
export const SKILL_EFFECT_STRING: SkillEffectString = {
  ...
  101103: { beforeValue: 'SP 특기로 획득하는 볼티지가 자신 테크닉의', afterValue: '% 추가' },
